...
Template.sales.helpers({
    //Retrieve the sale info
    itemsOnSales: function() {
        return Session.get('productArray').productName;
  }
});

//Put item into the item cart once user pressed "buy"
Template.productList.events({
    'click #buyBtn': function (e) {
      e.preventDefault();
      
      Session.set('shoppingCart', Session.get('productArray').productName);
    }
});

//get the value for the item cart
